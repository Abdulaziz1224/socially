...
function Number() {
  ...
  return (
    <div className="number" style={{display:form=="number"?"block":"none"}}>
      <div className="container" className={form=="number"?"container active":"container active"}>
        ...
        <div className="box">
          ...
          <input
            ...
            maxLength="19"/>
          <Link to="/" className="check" onClick={()=>{setForm("authNumber")}}>
            Tekshirish
